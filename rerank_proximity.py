...
Single-model mode (backward compatible):
    python rerank_proximity.py --model kgat_all --alpha 0.3 --bandwidth 10

Grid-search mode (sweeps alpha × bandwidth on GRID_SEARCH_MODELS):
    python rerank_proximity.py --grid-search
    python rerank_proximity.py --grid-search --top-k 100
"""
