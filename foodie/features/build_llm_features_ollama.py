...
Prepare and audit corpora without calling an LLM::
    ...
    python -m foodie.features.build_llm_features_ollama --prepare-only

Small smoke test::

    python -m foodie.features.build_llm_features_ollama --limit 20 --entities both

Full structured + embedding build::

    python -m foodie.features.build_llm_features_ollama --entities both --with-embeddings
"""
