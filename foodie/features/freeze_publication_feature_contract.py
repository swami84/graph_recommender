...
CODE = [
    "foodie/features/update_reviewer_demographics.py",
    "foodie/features/classify_other_cuisines_27b.py",
    "foodie/features/refine_unknown_cuisines_v4.py",
    "foodie/features/audit_and_assemble_llm_features.py",
    "foodie/features/audit_legacy_feature_coverage.py",
    "foodie/features/build_extended_features.py",
    "foodie/features/build_training_features.py",
    "foodie/modeling/recommendation_kgat.py",
    "foodie/modeling/recommendation_kgat_sal.py",
    "foodie/modeling/run_focused_llm_experiments.py",
    "analysis/expanded_eda/run_eda.py",
    "foodie/features/freeze_publication_feature_contract.py",
]
