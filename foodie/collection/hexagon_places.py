...
Usage:
    python -m foodie.collection.hexagon_places                    # process all CBGs
    python -m foodie.collection.hexagon_places --cbg 360610031001 # single CBG
    python -m foodie.collection.hexagon_places --limit 5          # first 5 CBGs only
