...
Usage:
    python -m foodie.modeling.recommendation_gnn                 # train + evaluate
    python -m foodie.modeling.recommendation_gnn --epochs 100
    python -m foodie.modeling.recommendation_gnn --recommend CONTRIBUTOR_ID
"""
...
def main():
    ...
    parser.add_argument("--use-dish-graph", action="store_true",
                        help="Enable dish heterogeneous graph path (requires "
                             "the precomputed dish-profile artifacts)")
