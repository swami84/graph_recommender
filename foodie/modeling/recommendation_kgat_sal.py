...
Usage:
    python -m foodie.modeling.recommendation_kgat_sal --prebuilt-features
    python -m foodie.modeling.recommendation_kgat_sal --epochs 300 --emb-dim 2048 --n-periods 3 \\
...
from foodie.modeling.recommendation_kgat import build_kg, N_RELATIONS
